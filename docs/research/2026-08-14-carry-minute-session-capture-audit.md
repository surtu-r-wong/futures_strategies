...
对象只是现有 Timescale hypertable 的内部分块，不是独立备份源。原始供应商归档
`期货数据/1m/2005-2024/SHFE/AL/AL1803.csv` 也从 2017-12-29 14:59
直接跳到 2018-01-02 21:00；全部 `AL18*.csv` 在 2018-01-02 日盘合计为
0 行。该文件 SHA-256 为
`dce42c7799aced51ae2cefcbde370dbf9abf3ab43a080d70d00f41d90d55131c`。
因此这是上游归档缺口，不是转换或装载漏行，库内也没有可替代的历史分钟表。
继续完整分钟复现前必须从可审计来源修复 2018-01-02 AL 日盘分钟数据；
