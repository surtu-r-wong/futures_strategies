...
| CZCE | holiday_no_night_rule | 法定节假日后的首个交易日没有前一晚夜盘（《夜盘交易业务操作指引》第八条逐字：「法定节假日（不包含双休日）后第一个交易日无夜盘交易」） | https://www.czce.com.cn/cn/rootfiles/2014/11/24/1415698818159779-1415698818161921.pdf | 37 | `reviewed_rule_plus_union`（2026-08-19 用户裁决）：规则由本 PDF 坐实，**日期取 SHFE/DCE/INE 三所已登记前夕的并集**。依据：除技术性故障外交易所一致行动。经验交叉验证 37/37 吻合、零郑商所特例，见 `docs/research/2026-08-19-czce-calendar-ruling.md` |
