...
DECISIONS: tuple[Decision, ...] = (
    ...
    Decision(
        ...
        "（全历史实测更高：wide 9,164 倍、narrow 1,607 倍，见下方 D22。）见 "
    ...
    Decision(
        ...
        "这是该读法的代价而非实现缺陷。"
        "【2026-09-01 实测定稿】四种节拍全跑完：换手 1,607 / 1,035 / 954 / 947 倍，"
        "把再平衡整个关掉（entry）也只降到研报隐含 291 倍的 **3.26 倍**，"
        "残余 97.5% 是研报明文写死的信号换手。节拍这个自由度补不上缺口 —— "
        "见 docs/research/2026-08-31-continuous-turnover-verdict.md §七",
    ),
)
